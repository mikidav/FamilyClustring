...
def get_creationdate_with_filename_as_dict(list_of_folders):
    scribble( "Processing all image files in:" )
    ...
    for folder in list_of_folders:
        ...
        for f in os.listdir(folder):
            ...
            try:
                ...
                scribble( "    Skipping '%s' due to exception: %s" )%(f, e)
                continue
        ...
        scribble( "  Found %s orignal files in %s." )%(counter, folder)
    scribble( "Added total of %s to dictionary." )%len(result)
    return result
...
def copy_from_image_dict_to_directory(image_dict, output_dir):
    ...
    scribble( "Copied %s files to %s" )%(i+1, output_dir)


if __name__=="__main__":
    source_dir = "C:/Users/mikid/PycharmProjects/pythonProject1/1/2018/unknown_city"
    output_dir = "C:/Users/mikid/PycharmProjects/pythonProject1/1/2018/unknown_city/1"
